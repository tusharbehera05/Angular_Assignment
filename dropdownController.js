 (function(angular, undefined) {
  ...
  var module = angular.module('myAssignment', []);
  ...
  (function () {
   var app = angular.module('myAssignment');
   //custom directive of nameList1 list under the scope array
   app.controller('myCtl', ['$scope', '$timeout', '$q', function ($scope, $timeout, $q) {
                            $scope.searchAsync = function (term) {
                            if (!term) {
                            return  ['Rahul', 'Sudan', 'Mayank','Arunraj','Tushar'];
                            }
                            ...
                            $scope.nameList1 = ['Rahul', 'Sudan', 'Mayank','Arunraj','Tushar'];
                            $scope.level1 = $scope.nameList1[0];
                            $scope.level1Options = {
                            ...
                            $scope.nameList2 = items;
                            }
                            };
                            $scope.nameList2 = [];
                            $scope.level1Options.onSelect($scope.nameList1[0]);
                            }]);
